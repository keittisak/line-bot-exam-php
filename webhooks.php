...
function createAnswer ($text)
{
        ...
        $corpus = [
            ...
            '2' => [
                'ยังไงวันนี้','กินเบียร','เหล้า','มีดื่มไหม','ยังไง'
            ],
            '3' => [
                'วันนี้กินอะไรดี'
            ],
        ...
        $botAnswer = [
            ...
            6 => [
                'ยุ่งควยอะไรระ', 'อย่ามาเพ่อเจ่อ','เสือกสัส','สบายใจก็ทำไป', 'ก็แล้วแต่นะ','เพื่อนเล่นเมิงว่างั้น','ควยทุกคน'
            ],
